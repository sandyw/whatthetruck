describe "TruckView", ->
  ...
  describe "render", ->
    beforeEach ->
      ...
      app.map = {map: 'I am a map.'}
      @truck = new app.Truck({ name: "Truckee", geocoded_address: "1 Laurel Street", hours: "9am-5pm", latitude: 123.0, longitude: 456.0 })
    ...
    xit "adds a pin to the map", ->
      ...
      expect(@view.marker.map).toEqual(app.map)
